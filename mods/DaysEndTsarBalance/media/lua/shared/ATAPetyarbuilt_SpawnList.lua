...
VehicleZoneDistribution.bigtrailerparkinglot.vehicles["Base.TrailerTSMega"] = {index = -1, spawnChance = 400};
VehicleZoneDistribution.bigtrailerparkinglot.vehicles["Base.ATAPetyarbuilt"] = {index = -1, spawnChance = 100};
VehicleZoneDistribution.bigtrailerparkinglot.vehicles["Base.ATAPetyarbuiltSleeper"] = {index = -1, spawnChance = 100};
VehicleZoneDistribution.bigtrailerparkinglot.vehicles["Base.ATAPetyarbuiltSleeperLong"] = {index = -1, spawnChance = 100};
VehicleZoneDistribution.parkingstall.vehicles["Base.TrailerTSMega"] = {index = -1, spawnChance = 4};
